...
-- Allow operators to view all employee fees
-- Option 1: If you have user_roles table, use this policy:
...
-- Option 2: If you don't have user_roles table, use this policy (based on user metadata):
CREATE POLICY "Employee fees: operators can view all" ON public.employee_fees
  FOR SELECT USING (
